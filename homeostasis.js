var homeostasis = function(id) {
  ...
  var flagella = function(spec) {
    ...
    spec.revertingshape = spec.shape || flux.shape({ops: [
      ...
      {op: 'bezier', to: $V([60, 70]), control1: $V([700, -70]), control2: $V([400, -40])},
      {op: 'line', to: $V([60, 40])},
      {op: 'line', to: $V([30, 40])},
      {op: 'line', to: $V([30, 100])},
      {op: 'line', to: $V([-50, 110])}
