var evader = function(spec) {
  ...
  that.element = document.getElementById(spec.element);
  that.over = spec.over;
  that.out = spec.out;
  ...
  document.onmousemove = that.track;
  that.element.onmouseover = that.accept;
  that.element.onmouseout = that.reject;
